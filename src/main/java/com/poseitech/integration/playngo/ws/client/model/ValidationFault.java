...
public class ValidationFault implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -2000309008494414576L;

   /*
    * This type was generated from the piece of schema that had name =
    * ValidationFault Namespace URI =
    * http://www.microsoft.com/practices/EnterpriseLibrary/2007/01/wcf/
    * validation Namespace Prefix = ns5
    */
   ...
   public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            ...
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ValidationFault", xmlWriter);
         }
      }

      if (localDetailsTracker) {
         if (localDetails == null) {
            writeStartElement(null, "http://www.microsoft.com/practices/EnterpriseLibrary/2007/01/wcf/validation",
                  "Details", xmlWriter);
