 ...
 */
public class GetTicketResponse implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = 7182069686686471719L;

   public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://playngo.com/v1",
         "GetTicketResponse", "ns3");
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                  namespacePrefix + ":GetTicketResponse", xmlWriter);
         } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetTicketResponse", xmlWriter);
         }
      }
   ...
   public static class Factory {
      ...
      public static GetTicketResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         GetTicketResponse object = new GetTicketResponse();
         ...
         try {
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"GetTicketResponse".equals(type)) {
                     ...
                     return (GetTicketResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "Ticket").equals(reader.getName()))
                  || new javax.xml.namespace.QName("", "Ticket").equals(reader.getName())) {
