...
/**
 * DebitResponse bean class
 */
public class DebitResponse implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -3196550332441773279L;
   ...
   public void setTransactionId(long param) {
      ...
      localTransactionIdTracker = param != java.lang.Long.MIN_VALUE;
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                  namespacePrefix + ":DebitResponse", xmlWriter);
         } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DebitResponse", xmlWriter);
         }
      }
   ...
   public static class Factory {
      ...
      public static DebitResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         DebitResponse object = new DebitResponse();
         ...
         try {
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"DebitResponse".equals(type)) {
                     ...
                     return (DebitResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "TransactionId").equals(reader.getName()))
                  || new javax.xml.namespace.QName("", "TransactionId").equals(reader.getName())) {
               nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

               if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                  throw new org.apache.axis2.databinding.ADBException(
                        "The element: " + "TransactionId" + "  cannot be null");
               }

               java.lang.String content = reader.getElementText();

               object.setTransactionId(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(content));

               reader.next();
            } // End of if for expected property start element

            else {
               object.setTransactionId(java.lang.Long.MIN_VALUE);
            }
