 ...
 */
public class ArrayOfValidationDetail implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = 4193224703139398242L;

   /*
    * This type was generated from the piece of schema that had name =
    * ArrayOfValidationDetail Namespace URI =
    * http://schemas.datacontract.org/2004/07/Microsoft.Practices.
    * EnterpriseLibrary.Validation.Integration.WCF Namespace Prefix = ns4
    */
   ...
   public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            ...
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfValidationDetail",
                  xmlWriter);
         }
      }
   ...
   public static class Factory {
       ...
       */
      public static ArrayOfValidationDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         ...
         try {
            ...
            if ((reader.isStartElement() && new javax.xml.namespace.QName(
                  ...
                  || new javax.xml.namespace.QName("", "ValidationDetail").equals(reader.getName())) {
