...
/**
 * ServiceFault bean class
 */
public class ServiceFault implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -7709849195451849990L;

   /*
    * This type was generated from the piece of schema that had name =
    * ServiceFault Namespace URI = http://playngo.com/v1 Namespace Prefix = ns3
    */

   /**
    * field for ErrorId
    */
   protected ErrorCode localErrorId;
    ...
    *           ErrorId
    */
   public void setErrorId(ErrorCode param) {
   ...
   public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                  namespacePrefix + ":ServiceFault", xmlWriter);
         } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ServiceFault", xmlWriter);
         }
      }
      ...
      localErrorId.serialize(new javax.xml.namespace.QName("http://playngo.com/v1", "ErrorId"), xmlWriter);
   ...
   public static class Factory {
       ...
       */
      public static ServiceFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         ServiceFault object = new ServiceFault();
         ...
         try {
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"ServiceFault".equals(type)) {
                     // find namespace for the prefix
                     java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

                     return (ServiceFault) ExtensionMapper.getTypeObject(nsUri, type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "ErrorId").equals(reader.getName()))
                  || new javax.xml.namespace.QName("", "ErrorId").equals(reader.getName())) {
               object.setErrorId(ErrorCode.Factory.parse(reader));

               reader.next();
            } // End of if for expected property start element

            else {
               // 1 - A start element we are not expecting indicates an invalid
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "ErrorMessage").equals(reader.getName()))
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "Details").equals(reader.getName()))
                  || new javax.xml.namespace.QName("", "Details").equals(reader.getName())) {
               nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

               if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                  java.lang.String content = reader.getElementText();

                  object.setDetails(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
               } else {
                  reader.getElementText(); // throw away text nodes if any.
               }
