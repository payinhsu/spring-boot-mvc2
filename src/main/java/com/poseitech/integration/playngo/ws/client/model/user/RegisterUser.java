 ...
 */
public class RegisterUser implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -8411155793606442163L;
    ...
    * field for UserInfo
    */
   protected GameUser localUserInfo;
    ...
    *           UserInfo
    */
   public void setUserInfo(GameUser param) {
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                  namespacePrefix + ":RegisterUser", xmlWriter);
         } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RegisterUser", xmlWriter);
         }
      }

      if (localUserInfoTracker) {
         if (localUserInfo == null) {
            writeStartElement(null, "http://playngo.com/v1", "UserInfo", xmlWriter);

            // write the nil attribute
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
            xmlWriter.writeEndElement();
         } else {
            localUserInfo.serialize(new javax.xml.namespace.QName("http://playngo.com/v1", "UserInfo"), xmlWriter);
         }
      }
   ...
   public static class Factory {
      ...
      public static RegisterUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         RegisterUser object = new RegisterUser();
         ...
         try {
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"RegisterUser".equals(type)) {
                     ...
                     return (RegisterUser) ExtensionMapper.getTypeObject(nsUri, type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement()
                  && new javax.xml.namespace.QName("http://playngo.com/v1", "UserInfo").equals(reader.getName()))
                  || new javax.xml.namespace.QName("", "UserInfo").equals(reader.getName())) {
               ...
               if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                  ...
                  object.setUserInfo(GameUser.Factory.parse(reader));
