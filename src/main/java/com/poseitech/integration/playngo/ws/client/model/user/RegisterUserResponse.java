 ...
 */
public class RegisterUserResponse implements org.apache.axis2.databinding.ADBBean {
   private static final long serialVersionUID = 8864207847362113822L;
   public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://playngo.com/v1",
         "RegisterUserResponse", "ns3");
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                  namespacePrefix + ":RegisterUserResponse", xmlWriter);
         } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RegisterUserResponse",
                  xmlWriter);
         }
      }
   ...
   public static class Factory {
      ...
      public static RegisterUserResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         RegisterUserResponse object = new RegisterUserResponse();
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"RegisterUserResponse".equals(type)) {
                     ...
                     return (RegisterUserResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
                  }
               }
            }
