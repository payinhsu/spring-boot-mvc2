 ...
 * MoneyE bean class
 */
public class MoneyE implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -5575941057555068079L;
   ...
   public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
      ...
      if (localMoney == null) {
         ...
         localMoney.serialize(MY_QNAME, xmlWriter);
      }
   }
   ...
   public static class Factory {
       ...
       */
      public static MoneyE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         MoneyE object = new MoneyE();
         ...
         try {
            ...
            while (!reader.isEndElement()) {
               if (reader.isStartElement()) {
                  if ((reader.isStartElement()
                        && new javax.xml.namespace.QName("http://playngo.com/v1", "Money").equals(reader.getName()))
                        || new javax.xml.namespace.QName("", "Money").equals(reader.getName())) {
                     nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
