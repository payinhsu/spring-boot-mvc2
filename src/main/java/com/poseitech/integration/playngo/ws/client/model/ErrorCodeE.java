...
/**
 * ErrorCodeE bean class
 */
public class ErrorCodeE implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -6098394481679036660L;
    ...
    * field for ErrorCode
    */
   protected ErrorCode localErrorCode;
    ...
    *           ErrorCode
    */
   public void setErrorCode(ErrorCode param) {
   ...
   public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
      ...
      if (localErrorCode == null) {
         ...
         localErrorCode.serialize(MY_QNAME, xmlWriter);
      }
   }
   ...
   public static class Factory {
       ...
       */
      public static ErrorCodeE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
         ErrorCodeE object = new ErrorCodeE();
         ...
         try {
            ...
            while (!reader.isEndElement()) {
               if (reader.isStartElement()) {
                  if ((reader.isStartElement()
                        && new javax.xml.namespace.QName("http://playngo.com/v1", "ErrorCode").equals(reader.getName()))
                     ...
                     if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setErrorCode(ErrorCode.Factory.parse(reader));
                     }
