...
public class CreditResponse implements org.apache.axis2.databinding.ADBBean {
   /**
    * 
    */
   private static final long serialVersionUID = -1033585869490922833L;
       ...
       if (serializeType) {
           ...
           if ((namespacePrefix != null) &&
               ...
               writeAttribute("xsi",
                   ...
                   namespacePrefix + ":CreditResponse", xmlWriter);
           } else {
               writeAttribute("xsi",
                   "http://www.w3.org/2001/XMLSchema-instance", "type",
                   "CreditResponse", xmlWriter);
           }
       }
   ...
   public static class Factory {
        ...
        */
       public static CreditResponse parse(
           javax.xml.stream.XMLStreamReader reader)
           throws java.lang.Exception {
           CreditResponse object = new CreditResponse();
           ...
           try {
               ...
               if (reader.getAttributeValue(
                   ...
                   if (fullTypeName != null) {
                       ...
                       if (!"CreditResponse".equals(type)) {
                           //find namespace for the prefix
                           java.lang.String nsUri = reader.getNamespaceContext()
                                                          .getNamespaceURI(nsPrefix);

                           return (CreditResponse) ExtensionMapper.getTypeObject(nsUri,
                               type, reader);
                       }
                   }
               }
               ...
               if ((reader.isStartElement() &&
                       new javax.xml.namespace.QName(
                           "http://playngo.com/v1", "TransactionId").equals(
                           reader.getName())) ||
