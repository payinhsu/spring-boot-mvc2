 ...
 * Balance bean class
 */
public class Balance implements org.apache.axis2.databinding.ADBBean {

   private static final long serialVersionUID = 5114474098162878561L;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Balance", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Balance", xmlWriter);
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Balance".equals(type)) {
                            ...
                            return (Balance) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
